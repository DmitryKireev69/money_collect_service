...
Веб приложение доступно по адресу http://localhost:8000/
Веб документация доступна по адресу http://localhost:8000/docs/
Локальный почтовый ящик доступен http://localhost:8080/
```
